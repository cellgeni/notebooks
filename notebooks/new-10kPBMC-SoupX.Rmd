...
```{r warning=FALSE}
filt.matrix <- Read10X_h5("../data/pbmc10k_filt.h5",use.names = T)
raw.matrix  <- Read10X_h5("../data/pbmc10k_raw.h5",use.names = T)
```
...
```{r}
DropletUtils:::write10xCounts("soupX_pbmc10k_filt", adj.matrix, version = "3")
```
